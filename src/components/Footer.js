...
const Footer = () => (
  <div class="bg-gray-800">
    ...
    <div class="text-gray-500 flex flex-col items-center pb-6">
      ...
      <a
        class="hover:text-teal-500 pt-2 flex items-center"
        href="tel:+1-307-214-5159"
      >
        <svg
          class="fill-current w-3 h-3 block"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
        >
          <title>Phone</title>
        ...
        <span class="pl-2 block">(307) 214-5159</span>
      </a>
      <a
        class="hover:text-teal-500 pt-2 flex items-center"
        href="mailto:stetson.ramey@gmail.com"
      >
        <svg
          class="fill-current w-4 h-4 block"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
        >
          <title>Email</title>
